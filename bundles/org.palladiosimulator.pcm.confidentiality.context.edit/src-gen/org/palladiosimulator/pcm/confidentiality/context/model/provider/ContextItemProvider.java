...
public class ContextItemProvider extends EntityItemProvider {
    ...
    protected void addContextPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Context_context_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Context_context_feature",
                                "_UI_Context_type"),
                        ModelPackage.Literals.CONTEXT__CONTEXT, true, false, true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(ModelPackage.Literals.CONTEXT__CONTEXT);
        }
    ...
    public void notifyChanged(Notification notification) {
        ...
        case ModelPackage.CONTEXT__CONTEXT:
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(ModelPackage.Literals.CONTEXT__CONTEXT,
