...
public class PolicyItemProvider extends EntityItemProvider {
    ...
    protected void addContextsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(), getString("_UI_Policy_contexts_feature"),
                        getString("_UI_PropertyDescriptor_description", "_UI_Policy_contexts_feature",
                                "_UI_Policy_type"),
                        PolicyPackage.Literals.POLICY__CONTEXTS, true, false, true, null, null, null));
    }
    ...
    public String getText(Object object) {
        String label = ((Policy) object).getId();
        return label == null || label.length() == 0 ? getString("_UI_Policy_type")
