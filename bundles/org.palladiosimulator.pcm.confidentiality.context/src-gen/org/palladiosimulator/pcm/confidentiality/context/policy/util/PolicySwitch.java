...
public class PolicySwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case PolicyPackage.POLICY_CONTAINER: {
            ...
            if (result == null)
                result = caseEntity(policyContainer);
            if (result == null)
                result = caseIdentifier(policyContainer);
            if (result == null)
                result = caseNamedElement(policyContainer);
            if (result == null)
        ...
        case PolicyPackage.POLICY: {
            ...
            if (result == null)
                result = caseEntity(policy);
            if (result == null)
                result = caseIdentifier(policy);
            if (result == null)
                result = caseNamedElement(policy);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
