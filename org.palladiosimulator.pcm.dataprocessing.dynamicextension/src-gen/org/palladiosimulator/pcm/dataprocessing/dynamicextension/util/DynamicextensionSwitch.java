...
public class DynamicextensionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DynamicextensionPackage.DYNAMIC_SPECIFICATION: {
			DynamicSpecification dynamicSpecification = (DynamicSpecification) theEObject;
			T result = caseDynamicSpecification(dynamicSpecification);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dynamic Specification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dynamic Specification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDynamicSpecification(DynamicSpecification object) {
		return null;
	}
