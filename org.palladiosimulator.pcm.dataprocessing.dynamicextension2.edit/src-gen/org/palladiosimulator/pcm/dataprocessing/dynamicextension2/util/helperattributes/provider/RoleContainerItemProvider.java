...
import org.palladiosimulator.pcm.dataprocessing.dynamicextension2.util.helperattributes.RoleContainer;

/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.dynamicextension2.util.helperattributes.RoleContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleContainerItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoleContainer_organisation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoleContainer_organisation_feature", "_UI_RoleContainer_type"),
				 HelperattributesPackage.Literals.ROLE_CONTAINER__ORGANISATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HelperattributesPackage.Literals.ROLE_CONTAINER__ROLE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RoleContainer.class)) {
			case HelperattributesPackage.ROLE_CONTAINER__ROLE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HelperattributesPackage.Literals.ROLE_CONTAINER__ROLE,
				 HelperattributesFactory.eINSTANCE.createRole()));
	}
