...
import org.palladiosimulator.pcm.dataprocessing.dynamicextension2.util.subject.Subject;
import org.palladiosimulator.pcm.dataprocessing.dynamicextension2.util.subject.SubjectPackage;

/**
 * This is the item provider adapter for a {@link org.palladiosimulator.pcm.dataprocessing.dynamicextension2.util.subject.Subject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubjectItemProvider extends EntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subject_contexts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subject_contexts_feature", "_UI_Subject_type"),
				 SubjectPackage.Literals.SUBJECT__CONTEXTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Subject)object).getId();
